...
- **Component VaR for attribution** uses the Euler decomposition identity. This is the standard risk budget report format at sell-side risk desks.budget report format at sell-side risk desks.
